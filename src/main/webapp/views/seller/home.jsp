    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1>
                    Home <small>statistics & reports</small>
                </h1>
            </div>
            <!-- END PAGE TITLE -->
                            ...
                            <table class="table table-hover table-light">
                                ...
                                <tr>
                                    <td class="fit"><img class="user-pic"
                                                         src="<c:url value="/templates/assets/admin/layout3/img/avatar4.jpg"></c:url>">
                                    </td>
                                ...
                                <tr>
                                    <td class="fit"><img class="user-pic"
                                                         src="<c:url value="/templates/assets/admin/layout3/img/avatar5.jpg"></c:url>">
                                    </td>
                                ...
                                <tr>
                                    <td class="fit"><img class="user-pic"
                                                         src="<c:url value="/templates/assets/admin/layout3/img/avatar6.jpg"></c:url>">
                                    </td>
                                ...
                                <tr>
                                    <td class="fit"><img class="user-pic"
                                                         src="<c:url value="/templates/assets/admin/layout3/img/avatar7.jpg"></c:url>">
                                    </td>
                            ...
                            <div class="general-item-list">
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic"
                                                 src="<c:url value="/templates/assets/admin/layout3/img/avatar3.jpg"></c:url>">
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic"
                                                 src="<c:url value="/templates/assets/admin/layout3/img/avatar9.jpg"></c:url>">
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic"
                                                 src="<c:url value="/templates/assets/admin/layout3/img/avatar8.jpg"></c:url>">
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic"
                                                 src="<c:url value="/templates/assets/admin/layout3/img/avatar2.jpg"></c:url>">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        <div id="region_statistics_loading">
                            <img
                                    src="<c:url value="/templates/assets/admin/layout/img/loading.gif"></c:url>"
                                    alt="loading"/>
                        </div>
